...
public class Stage02_Igloo : StageData
{
    int[,] maxRect;
    ...
    public override void Awake()
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            temp = Resources.Load("TerrainData/Stage02/Igloo") as Texture2D;
            variation.Add(temp);
        }
    ...
    public override void GenerateData()
    {
        ...
        MonsterManager.instance.Init(world, StageManager.instance.Igloo_Monsters.monsterNum, StageManager.instance.Igloo_Monsters.monsterDistance);
    }
    #endregion
