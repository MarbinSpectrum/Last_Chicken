...
public class Stage02_3 : StageData
{
    int[,] maxRect;
    ...
    public override void GenerateData()
    {
        ...
        MonsterManager.instance.Init(world, StageManager.instance.stage0203_Monsters.monsterNum, StageManager.instance.stage0203_Monsters.monsterDistance);
    }
    #endregion
