...
public class Stage01_3 : StageData
{
    ...
    public override void GenerateData()
    {
        ...
        MonsterManager.instance.Init(world, StageManager.instance.stage0103_Monsters.monsterNum, StageManager.instance.stage0103_Monsters.monsterDistance);
    }
    #endregion
    ...
    void SetObject()
    {
        ...
        for (int i = 0; i < mineRoadArea.Count; i++)
        {
            ...
            for (int j = 0; j < 15; j++)
            {
                ...
                if (Random.Range(0, 100) <= StageManager.instance.stage0103_ObjectValue || 
            ...
            //    if (Random.Range(0, 100) <= StageManager.instance.stage0103_WoodBoxValue ||
            //        !Exception.IndexOutRange(mineRoadArea[i].x + addX, mineRoadArea[i].y - mineRoadArea[i].height - 1, groundData) ||
            //        (Exception.IndexOutRange(mineRoadArea[i].x + addX, mineRoadArea[i].y - mineRoadArea[i].height - 1, groundData) &&
            //        groundData[mineRoadArea[i].x + addX, mineRoadArea[i].y - mineRoadArea[i].height - 1] == (GroundLayer)(-1)))
            //    {
            ...
            for (int j = 0; j < 15; j++)
            {
                ...
                if (Random.Range(0, 100) <= StageManager.instance.stage0103_TrapValue)
                    continue;
        ...
        for (int x = 0; x <= dw; x++)
            for (int y = 0; y <= dh; y++)
                if (Random.Range(0, 100) < 40)
                    ObjectManager.instance.Vine(new Vector2(x * w, y * h), Random.Range(4, 8), Random.Range(0, 2) == 0 ? true : false);
        #endregion
