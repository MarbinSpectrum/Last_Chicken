...
namespace TerrainEngine2D
{
    ...
    public class CameraController : MonoBehaviourSingleton<CameraController>
    {
        ...
        [SerializeField]
        public Vector2 objectCameraOffset;
        ...
        public void CameraOffset()
        {
            ...
            if(Mathf.Abs(objectCameraOffset.y - offsetY) < 0.1f)
                objectCameraOffset.y = offsetY;

            if (objectCameraOffset.y < offsetY)
                objectCameraOffset.y += Time.deltaTime*10;
            else if (objectCameraOffset.y > offsetY)
                objectCameraOffset.y -= Time.deltaTime*10;
