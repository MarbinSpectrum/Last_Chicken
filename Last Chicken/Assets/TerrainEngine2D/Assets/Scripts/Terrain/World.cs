...
namespace TerrainEngine2D
{
    ...
    public class World : MonoBehaviourSingleton<World>
    {
        ...
        public void Initialize()
        {
            ...
            Seed = worldData.Seed;
            Seed = UnityEngine.Random.Range(int.MinValue / 100, int.MaxValue / 100);
        ...
        public void UpdateBitmask(int x, int y, int width, int height, byte layer, bool newOverlapBlock = false, byte blockType = 0)
        {
